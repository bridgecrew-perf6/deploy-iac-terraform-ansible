...
ansible-playbook --extra-vars 'passed_in_hosts=tag_Name-${self.tags.Name}' ansible_templates/jenkins-master-sample.yml
EOF
  }
}
...
ansible-playbook --extra-vars 'passed_in_hosts=tag_Name-${self.tags.Name}' ansible_templates/jenkins-worker-sample.yml
EOF
  }
}
